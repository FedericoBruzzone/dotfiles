...
l4p () {
	BIB_DIR=${BIBINPUTS%%:*} 
	grep --color=auto --exclude-dir={.bzr,CVS,.git,.hg,.svn,.idea,.tox,.venv,venv} -rin"$2" -ie "$1" "$BIB_DIR"/*.bib
}
mkcd () {
	mkdir -p $@ && cd ${@:$#}
}
...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  [[ -x $_cc_bin ]] || _cc_bin=/Users/federicobruzzone/.local/bin/claude
...
export PATH=/Users/federicobruzzone/dev/llvm-pipa/notebooks/.venv/bin:/Users/federicobruzzone/valgrind-install/bin:/opt/homebrew/opt/llvm/bin:/usr/local/Cellar/python@3.11/3.11.14_1/libexec/bin:/Users/federicobruzzone/.bin:/opt/homebrew/opt/openvpn/sbin/:/usr/local/sbin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/opt/pmk/env/global/bin:/Library/Apple/usr/bin:/opt/homebrew/bin:/Users/federicobruzzone/valgrind-install/bin:/opt/homebrew/opt/llvm/bin:/Users/federicobruzzone/perl5/bin:/Users/federicobruzzone/.opam/rocq/bin:/usr/local/Cellar/python@3.11/3.11.14_1/libexec/bin:/Users/federicobruzzone/.bin:/opt/homebrew/opt/openvpn/sbin/:/usr/local/sbin:/Users/federicobruzzone/.cargo/bin:/Users/federicobruzzone/.local/bin:/Users/federicobruzzone/.local/bin
